...
if __name__ == '__main__':
    # --- Configuration ---
    exp_dir = "Runs/Sweep/MiniGrid-FourRooms-v0_/ViewSize(agent_view_size-9)_FlattenOnehotObj_FixedSeed(seed-5000)_FixedRandomDistractor(num_distractors-40_seed-100)/OptionA2C/Mask-input-l1-Reg-0.01_seed[1]"
    ratio   = 0.5
    # ---------------------
