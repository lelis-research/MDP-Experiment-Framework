...
MINIGRID_ENV_LST = [
    ...
    "MiniGrid-BlockedUnlockPickupReplaceCarry-v0",
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Quick MiniGrid vectorized env smoke test.")
    parser.add_argument("--env", type=str, choices=MINIGRID_ENV_LST, default="MiniGrid-DoorKey-5x5-v0", help="MiniGrid env id to create.")
