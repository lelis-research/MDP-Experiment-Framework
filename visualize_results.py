...
from RLBase.Options.SymbolicOptions.ManualSymbolicOptions import ALL_OPTIONS
if __name__ == "__main__":
    ...
    plot_experiments(agent_dict, "Runs/Figures", name=f"test1", window_size=1, show_ci=True, ignore_last=True, 
