...
if __name__ == "__main__":
    ...
    agent_dict = {
        ...
        # "Continual_max-schedule": gather_experiments(ContinualOptionQLearning_TwoGoals, name_string_conditions=["schedule-init_max-"], name_string_anti_conditions=[]),
        ...
        # "Continual_zero-schedule": gather_experiments(ContinualOptionQLearning_TwoGoals, name_string_conditions=["schedule-init_zero-"], name_string_anti_conditions=[]),
        ...
        # "Continual_reset-schedule": gather_experiments(ContinualOptionQLearning_TwoGoals, name_string_conditions=["schedule-reset-"], name_string_anti_conditions=[]),
        ...
        # "Continual-entropy-beta0-schedule": gather_experiments(ContinualOptionQLearning_TwoGoals, name_string_conditions=["schedule-init_uncertainty-entropy-beta0-"], name_string_anti_conditions=[]),
        ...
        # "Continual-entropy-beta1-schedule": gather_experiments(ContinualOptionQLearning_TwoGoals, name_string_conditions=["schedule-init_uncertainty-entropy-beta1-"], name_string_anti_conditions=[]),
        ...
        # "Continual-margin-beta0-schedule": gather_experiments(ContinualOptionQLearning_TwoGoals, name_string_conditions=["schedule-init_uncertainty-margin-beta0-"], name_string_anti_conditions=[]),
        ...
        # "Continual-margin-beta1-schedule": gather_experiments(ContinualOptionQLearning_TwoGoals, name_string_conditions=["schedule-init_uncertainty-margin-beta1-"], name_string_anti_conditions=[]),
        
        
        
    }

    # plot_experiments(agent_dict, "Runs/Figures", name=f"TwoGoals_AlmostAllOptions", window_size=1, show_ci=True, ignore_last=True, 
    #                  plt_configs=["r_s", "ou_s", "no_s"], plot_each=False)
    
    plot_experiments(agent_dict, "Runs/Figures", name=f"TwoGoals_AlmostAllOptions-test", window_size=1, show_ci=True, ignore_last=True, 
                     plt_configs=["oc_heat"], plot_each=False)
