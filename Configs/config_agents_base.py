...
AGENT_DICT = {
    ...
    PPOAgent.name: lambda env, info: PPOAgent(
        ...
        HyperParameters(
            ...
            actor_network=NETWORK_PRESETS[info.get("actor_network", "MiniGrid/PPO/conv_fuse_imgdir_actor")],
            actor_step_size=info.get("actor_step_size", 3e-4),
            actor_eps = info.get("actor_eps", 1e-8),
            clip_range_actor_init=info.get("clip_range_actor_init", 0.2),
            anneal_clip_range_actor=info.get("anneal_clip_range_actor", False),
            
            critic_network=NETWORK_PRESETS[info.get("critic_network", "MiniGrid/PPO/conv_fuse_imgdir_critic")],
            critic_step_size=info.get("critic_step_size", 3e-4),
            critic_eps = info.get("critic_eps", 1e-8),
    ...
    VQOptionCriticAgent.name: lambda env, info: VQOptionCriticAgent(
        ...
        HyperParameters(            
            ...
            hl = HyperParameters(
                ...
                actor_network=NETWORK_PRESETS[info.get("hl_actor_network", "MiniGrid/PPO/conv_fuse_actor")],
                ...
                critic_network=NETWORK_PRESETS[info.get("hl_critic_network", "MiniGrid/PPO/conv_fuse_critic")],
